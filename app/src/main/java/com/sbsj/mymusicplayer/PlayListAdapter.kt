...
class PlayListAdapter(private val callback: (MusicModel) -> Unit):androidx.recyclerview.widget.ListAdapter<MusicModel, PlayListAdapter.ViewHolder>(diffUtil) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        currentList[position].also {
            musicModel -> holder.bind(musicModel)
        }
    }
